...
public class CommentController {
	...
	// R - List
//	@GetMapping("/comments")
//	public ResponseEntity<List<Comment>> getList(@RequestParam(defaultValue = "") String mode, @RequestParam(defaultValue = "") String keyword) {
//		HashMap<String, String> params = new HashMap<String, String>();
//		params.put("mode", mode);
//		params.put("keyword", keyword);
//		return new ResponseEntity<List<Comment>>(commentService.getList(params), HttpStatus.OK);
//	}
	// U
